...
import WheelProducts from "./WheelProducts";

const WheelProductScreen = ({ closeModal }) => {
  ...
  useEffect(() => {
    ...
    if (searchQuery.trim() === "") {
      const filtered = products.filter((product) => product.wheel === "true");
...
export default WheelProductScreen;
